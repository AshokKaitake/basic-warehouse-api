...
import com.playground.warehouse.dto.ProductDTO;
import com.playground.warehouse.entities.Product;
import com.playground.warehouse.entities.ProductArticles;
import com.playground.warehouse.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
   ...
   */
  @Override
  public ResponseEntity<BaseResponseEntities<Product>> getAvailableProductWithQuantity() {
    BaseResponseEntities<Product> availableProductWithQuantityResponse =
        new BaseResponseEntities<>();
   ...
   */
  @Override
  public ResponseEntity<BaseResponseEntity<Product>> sellProductByProductName(String productName) {
    BaseResponseEntity<Product> sellProductByProductNameResponse = new BaseResponseEntity<>();
    if (productName == null) {
    ...
    if (product.isPresent()) {
      ...
      sellProductByProductNameResponse.setResponseData(product.get());
   ...
   */
  @Override
  public ResponseEntity<BaseResponseEntities<Product>> importProductFile(MultipartFile file) {
    BaseResponseEntities<Product> importProductFileResponse = new BaseResponseEntities<>();
    try {
  ...
  public ResponseEntity<BaseResponseEntities<Product>> getAllProducts() {
    BaseResponseEntities<Product> getAllProductsResponse = new BaseResponseEntities<>();
    List<Product> productList = productRepository.findAll();
